...
export const users: User[] = [
  ...
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', status: 'Active', userType: 'Free', joinDate: 'Feb 10, 2024', avatar: '/women.png', issueDate: 'Feb 10, 2024', amount: 22.00, progress: '70' },
  { id: 3, name: 'Mike Johnson', email: 'mike@example.com', status: 'Inactive', userType: 'Paid', joinDate: 'Mar 5, 2024', avatar: '/isMan.png', issueDate: 'Mar 5, 2024', amount: 99.00, progress: '700' },
  { id: 4, name: 'Sarah Williams', email: 'sarah@example.com', status: 'Active', userType: 'Free', joinDate: 'Apr 12, 2024', avatar: '/man.png', issueDate: 'Apr 12, 2024', amount: 0.00, progress: '200' },
  { id: 5, name: 'Tom Brown', email: 'tom@example.com', status: 'Active', userType: 'Paid', joinDate: 'May 8, 2024', avatar: '/isMan.png', issueDate: 'May 8, 2024', amount: 199.00, progress: '150' },
    { id: 6, name: 'Sarah Williams', email: 'sarah@example.com', status: 'Active', userType: 'Free', joinDate: 'Apr 12, 2024', avatar: '/man.png', issueDate: 'Apr 12, 2024', amount: 0.00, progress: '80' },
  { id: 7, name: 'Tom Brown', email: 'tom@example.com', status: 'Active', userType: 'Paid', joinDate: 'May 8, 2024', avatar: '/isMan.png', issueDate: 'May 8, 2024', amount: 199.00, progress: '20' },
];
